...
export class HeroDetailComponent implements OnInit {
  ...
  */
  ...
  // Add a goBack() method to the component class that navigates
  //  backward one step in the browser's history stack using the 
  // Location service that you injected previously.
  goBack(): void{
    this.location.back();
  }
}
